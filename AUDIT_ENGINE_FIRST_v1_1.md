...
| # | Issue | Статус |
|---|-------|--------|
| 1 | Hardcoded Strings | 🟡 Частично (Combat + JSON done) |
| 2 | Тесты на двух стульях | ✅ Закрыто |
| 3 | Legacy Adapters | ✅ Частично (ContentView Engine-First) |
| 4 | Audit файлы | ✅ Закрыто |
| 5 | MIGRATION_PLAN.md | ✅ Закрыто |
| 6 | CI Configuration | ✅ Закрыто |
| 7 | Удаление Адаптеров | ✅ Частично (неиспользуемые удалены) |
| 8 | JSON Content | ✅ Полностью (loading + L10n + tests) |

**Итого:** 7/8 закрыто или частично завершено, 1/8 (Hardcoded Strings) требует дополнительной работы
