/// Файл: Packages/PackEditorKit/Tests/PackEditorKitTests/PackStoreTests.swift
/// Назначение: Содержит реализацию файла PackStoreTests.swift.
...
final class PackStoreTests: XCTestCase {
    ...
    func fixturePackURL() throws -> URL {
    ...
    func copyFixtureToTemp() throws -> URL {
