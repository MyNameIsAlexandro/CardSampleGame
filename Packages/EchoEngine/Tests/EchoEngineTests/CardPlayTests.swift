/// Файл: Packages/EchoEngine/Tests/EchoEngineTests/CardPlayTests.swift
/// Назначение: Содержит реализацию файла CardPlayTests.swift.
...
struct CardPlayTests {
    ...
    func makeEnemy(health: Int = 10, defense: Int = 0) -> EnemyDefinition {
        EnemyDefinition(
            id: "test_enemy",
            name: .key("enemy"),
    ...
    func makeFateCards() -> [FateCard] {
        (0..<10).map { i in
            FateCard(id: "fate_\(i)", modifier: 0, name: "Fate \(i)")
        }
    }

    func makeDamageCard(id: String = "dmg_card", damage: Int = 3) -> Card {
        Card(
            id: id,
            name: "Strike",
            type: .spell,
    ...
    func makeHealCard(id: String = "heal_card", amount: Int = 4) -> Card {
        Card(
            id: id,
            name: "Heal",
            type: .spell,
    ...
    func makeDrawCard(id: String = "draw_card", count: Int = 2) -> Card {
        Card(
            id: id,
            name: "Insight",
            type: .spell,
