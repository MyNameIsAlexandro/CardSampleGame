/// Файл: Packages/PackEditorApp/Sources/PackEditorApp/Views/Shared/HeroAbilityEffectEditor.swift
/// Назначение: Содержит реализацию файла HeroAbilityEffectEditor.swift.
