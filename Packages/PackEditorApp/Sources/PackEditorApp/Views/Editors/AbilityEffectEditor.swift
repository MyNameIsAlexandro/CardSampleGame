/// Файл: Packages/PackEditorApp/Sources/PackEditorApp/Views/Editors/AbilityEffectEditor.swift
/// Назначение: Содержит реализацию файла AbilityEffectEditor.swift.
