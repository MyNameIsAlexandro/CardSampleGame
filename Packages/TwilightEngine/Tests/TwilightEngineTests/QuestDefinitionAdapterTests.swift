/// Файл: Packages/TwilightEngine/Tests/TwilightEngineTests/QuestDefinitionAdapterTests.swift
/// Назначение: Содержит реализацию файла QuestDefinitionAdapterTests.swift.
