/// Файл: Packages/TwilightEngine/Sources/TwilightEngine/Data/Definitions/AnchorDefinition.swift
/// Назначение: Содержит реализацию файла AnchorDefinition.swift.
