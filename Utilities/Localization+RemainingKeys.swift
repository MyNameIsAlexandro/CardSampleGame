...
extension L10n {
        ...
        // MARK: - Disposition Combat
        static let dispositionActionSacrifice = "disposition.action.sacrifice"
        static let dispositionActionEndTurn = "disposition.action.end.turn"
        static let dispositionIntentAttack = "disposition.intent.attack"
        static let dispositionIntentRage = "disposition.intent.rage"
        static let dispositionIntentDefend = "disposition.intent.defend"
        static let dispositionIntentProvoke = "disposition.intent.provoke"
        static let dispositionIntentAdapt = "disposition.intent.adapt"
        static let dispositionIntentPlea = "disposition.intent.plea"
        static let dispositionFloatAttack = "disposition.float.attack"
        static let dispositionFloatRage = "disposition.float.rage"
        static let dispositionFloatDefend = "disposition.float.defend"
        static let dispositionFloatProvoke = "disposition.float.provoke"
        static let dispositionFloatAdapt = "disposition.float.adapt"
        static let dispositionFloatPlea = "disposition.float.plea"
        static let dispositionOutcomeDestroyed = "disposition.outcome.destroyed"
        static let dispositionOutcomeSubjugated = "disposition.outcome.subjugated"
        static let dispositionOutcomeDefeated = "disposition.outcome.defeated"
        static let dispositionOutcomeCombatOver = "disposition.outcome.combat.over"
        static let dispositionHintLongPress = "disposition.hint.long.press"
        static let dispositionDetailsModeNormal = "disposition.details.mode.normal"
        static let dispositionDetailsModeSurvival = "disposition.details.mode.survival"
        static let dispositionDetailsModeDesperation = "disposition.details.mode.desperation"
        static let dispositionDetailsModeWeakened = "disposition.details.mode.weakened"
        static let dispositionHandCount = "disposition.hand.count"
        static let dispositionDiscardCount = "disposition.discard.count"
        static let dispositionExhaustCount = "disposition.exhaust.count"
        static let fateKeywordSurge = "fate.keyword.surge"
        static let fateKeywordShadow = "fate.keyword.shadow"
        static let fateKeywordWard = "fate.keyword.ward"
        static let fateKeywordFocus = "fate.keyword.focus"
        static let fateKeywordEcho = "fate.keyword.echo"

        // MARK: - Stat Labels
        static let statHPShort = "stat.hp.short"
        static let statWPShort = "stat.wp.short"

        // MARK: - Statistics View
        static let statsTotalFights = "stats.total.fights"
        static let statsVictories = "stats.victories"
        static let statsDefeats = "stats.defeats"
        static let statsFled = "stats.fled"
        static let statsDamageDealt = "stats.damage.dealt"
        static let statsDamageTaken = "stats.damage.taken"
        static let statsEncountered = "stats.encountered"
        static let statsStudied = "stats.studied"
        static let statsMastered = "stats.mastered"
        static let statsTotalPlaythroughs = "stats.total.playthroughs"
        static let statsAchievements = "stats.achievements"
}
