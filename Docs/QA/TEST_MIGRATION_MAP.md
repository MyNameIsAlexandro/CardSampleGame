...
| # | Текущий тест | Текущий класс | Целевая директория | Целевой файл | Целевой ID/имя | Статус |
|---|-------------|---------------|-------------------|-------------|----------------|--------|
...
| 3 | `testSpiritualInfluenceReducesWPOnly` | GateTests/ | INV_ENC_GateTests | INV-ENC-002 (второй кейс) | 🔴 RED |
...
| 6 | `testIntentGeneratedAtRoundStart` | GateTests/ | INV_ENC_GateTests | INV-ENC-001 (aspect) | 🔴 RED |
...
| 15 | `testWaitHasNoHiddenFateDeckSideEffects` | GateTests/ | INV_FATE_GateTests | INV-FATE-002 (aspect) | 🔴 RED |
...
| 18 | `testEscalationUsesBalancePackValue` | GateTests/ | INV_BHV_GateTests | INV-BHV-004 (aspect) | 🔴 RED |
...
| # | Текущий тест | Целевая директория | Целевой файл | Целевой ID/имя | Статус |
|---|-------------|-------------------|-------------|----------------|--------|
| 25 | `testAllBehaviorReferencesExist` | GateTests/ | INV_BHV_GateTests | INV-BHV-003 (aspect) | 🔴 RED |
| 26 | `testFateCardIdsUnique` | GateTests/ | INV_FATE_GateTests | INV-FATE-001 (aspect) | 🔴 RED |
| 27 | `testFateCardSuitsValid` | GateTests/ | INV_FATE_GateTests | (new: INV-FATE-006) | 🔴 RED |
| 28 | `testChoiceCardsHaveBothOptions` | GateTests/ | INV_FATE_GateTests | (new: INV-FATE-007) | 🔴 RED |
| 29 | `testValueFormulaWhitelist` | GateTests/ | INV_BHV_GateTests | INV-BHV-004 | 🔴 RED |
| 30 | `testValueFormulaMultipliersExist` | GateTests/ | INV_BHV_GateTests | INV-BHV-004 (aspect) | 🔴 RED |
| 31 | `testBehaviorConditionsParsable` | GateTests/ | INV_BHV_GateTests | INV-BHV-002 (aspect) | 🔴 RED |
| 32 | `testIntentTypesValid` | GateTests/ | INV_BHV_GateTests | (new: INV-BHV-005) | 🔴 RED |
| 33 | `testFateCardKeywordsValid` | GateTests/ | INV_FATE_GateTests | (new: INV-FATE-008) | 🔴 RED |
...
| 38 | `testFateDeckStateGlobalAcrossContexts` | GateTests/ | INV_FATE_GateTests | INV-FATE-001 (aspect) | 🔴 RED |
| 39 | `testFateCardResolutionOrder` | LayerTests/ | FateDeckEngineTests | `testResolutionOrder` | 🔴 RED |
| 40 | `testMatchBonusMultiplierFromBalancePack` | GateTests/ | INV_BHV_GateTests | INV-BHV-004 (aspect) | 🔴 RED |

---

## Сводка по целевым директориям

| Директория | Количество тестов |
|-----------|------------------|
| GateTests/ | 16 |
| LayerTests/ | 17 |
| IntegrationTests/ | 7 |
