...
**Приоритет:** Critical
**Тип:** UI + Unit
**Файл:** `RegionActionsUITests.swift`
...
2. [x] Этап 1: Посетить Дремучий Лес
3. [x] Этап 2: Узнать о проблеме в Borderland
4. [x] Этап 3: Исследовать Разлом Курганов
4. [x] Этап 4: Найти путь к боссу
5. [x] Этап 5: Победить босса в Чёрной Низине
...
├── UI/                                 # 3 файла, ~45 тестов
│   ├── WorldMapUITests.swift           # Карта, навигация, индикаторы
│   ├── RegionActionsUITests.swift      # Действия в регионах
│   └── EventFlowUITests.swift          # Поток событий, выборы
...
| Категория | Unit | UI | Integration | Всего тестов |
|-----------|------|----|-------------|--------------|
| Инициализация (TEST-001) | ✅ 8 | ✅ 3 | - | 11 |
| Время/дни (TEST-002, 003) | ✅ 12 | - | ✅ 5 | 17 |
| Регионы (TEST-004, 005, 006) | ✅ 10 | ✅ 12 | ✅ 6 | 28 |
| События (TEST-007, 008) | ✅ 25 | ✅ 8 | ✅ 4 | 37 |
| Квесты (TEST-009, 010) | ✅ 15 | - | ✅ 10 | 25 |
| Бой (TEST-011, 012) | ✅ 35 | ✅ 5 | - | 40 |
| Колода (TEST-013, 014) | ✅ 40 | - | ✅ 8 | 48 |
| Сохранения (TEST-016) | ✅ 35 | ✅ 3 | - | 38 |
...
| WorldMapUITests.swift | Карта, навигация | ~15 | ~180 |
